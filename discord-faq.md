...
> **Latest version: 3.6.0** — 51 MCP tools · 10 read modes · 60+ shell patterns
...
1. **Shell Hook** — transparently compresses CLI output (git, ls, npm, cargo, etc.) using 60+ patterns before it reaches the LLM
2. **MCP Server** — 51 tools for cached file reads, 10 read modes, deltas, dedup, memory, multi-agent coordination, and more
...
**Q: Where can I find docs for all 51 tools?**
...
- **Full (default)**: All 51 tools available as separate `ctx_*` tools
