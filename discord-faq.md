...
> **Latest version: 3.6.0** — 56+ MCP tools · 10 read modes · 95+ shell patterns
...
2. **MCP Server** — 56+ tools for cached file reads, 10 read modes, deltas, dedup, memory, multi-agent coordination, and more
