...
(function () {
  ...
  var TIPS = {
    ...
    total_tokens_saved: 'Lifetime estimate of tokens saved through all compression modes since installation. For the stricter, cryptographically signed count see ROI & Plan.',
    cost_saved: 'Estimated dollar savings based on average LLM token pricing ($2.50/1M input tokens), counted since installation. ROI & Plan shows the verified (signed-ledger) figure.',
